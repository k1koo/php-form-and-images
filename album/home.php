    ...
    <div id="wrapper" class="col-lg-10 col-lg-offset-1">
        ...
        <nav>
            <ul>
                ...
                <li class="right_li"><a href="LOGIN2.php" class="btn-block btn-primary logout">Logout</a></li>
                <li class="right_li"><a class="btn-block btn-primary"><?php echo "Hello, " . $email = $_POST['email']; ?></a></li>
            </ul>  
        </nav>
